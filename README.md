...
# 1. Cleaner l'environnement (si existant)
```sh
...
Utilisez simplement le fichier requirements.txt mis à jour (incluant support GPU et nettoyage) :
```sh
.\venv_app_eeg\Scripts\pip install -r requirements.txt
```


# 3. Run the command to generate the build folder
